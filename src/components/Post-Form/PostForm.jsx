...
import service, { Service } from '../../appwrite/configApp'
...
function PostForm({ post }) {
    ...
    const submit = async (data) => {
        if (post) {
            ...
            const dbPost = await service.updatePost(post.$id, { ...data, featuredImage: file ? file.$id : undefined })//post.featuredImage
            if (dbPost) {
